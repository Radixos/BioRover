...
namespace FMODUnity
{
    ...
    public class StudioListenerEditor : Editor
    {
        ...
        EditorGUI.BeginChangeCheck();
            ...
            int temp = EditorGUILayout.MaskField("Occlusion Mask",
    UnityEditorInternal.InternalEditorUtility.LayerMaskToConcatenatedLayersMask(mask.intValue), UnityEditorInternal.InternalEditorUtility.layers);
